...
## displaying of vehicle infomation 
...
**PLACE SCREENSHOTS AND/OR ANIMATED GIFS OF THE IMPROVED SYSTEM HERE**
![alt text](<vehicle .gif>)

---

## continuation of emojis 
...
**PLACE SCREENSHOTS AND/OR ANIMATED GIFS OF THE IMPROVED SYSTEM HERE**
![alt text](image-12.png) ![alt text](image-13.png)![alt text](image-14.png) ![alt text](image-15.png)

---

## downloading of current logs user has 
